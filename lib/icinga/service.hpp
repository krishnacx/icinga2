...
private:
	...
	static bool EvaluateApplyRuleInstance(const Host::Ptr& host, const String& name, ScriptFrame& frame, const ApplyRule::Ptr& rule);
	static bool EvaluateApplyRule(const Host::Ptr& host, const ApplyRule::Ptr& rule);
};
